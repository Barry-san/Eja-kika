  ...
  return (
    <div className="p-4 md:px-7.5 py-12.5 grid grid-flow-row lg:grid-cols-2 gap-6 items-center">
      ...
      <section className="md:p-5 flex flex-col gap-3 md:gap-5 font-body">
        <h3 className="subheading bg-secondary border-divider text-primary w-fit text-sm md:text-base">
          About us
        </h3>
        <h2 className="text-2xl md:text-[36px] lg:text-[46px] leading-[1.2em] tracking-[-0.02em] text-primary font-bold">
          Smoked fish made for real meals and repeat customers
        </h2>

        <p className="text-copy font-body">
    ...
    <article className="flex flex-col gap-5 relative">
      ...
      <div className=" grid grid-cols-2 gap-5">
        <div className="bg-secondary rounded-3xl flex flex-col justify-center md:gap-5 p-5 text-primary font-bold">
          <img
            src="src/assets/icons/icon-about-image-item.svg"
            width={40}
            className="md:w-12.5"
          />
      ...
      >
        <img
          src="src/assets/icons/contact-us.svg"
          className="rotation block rounded-full"
        />
      </Link>
    </article>
  );
